  ...
  return (
    <div className="animate-fadeIn" style={{ display: "flex", flexDirection: "column", gap: "40px" }}>
      ...
      >
        ...
        {/* Glow decoration */}
        <div style={{ position: "absolute", right: "-10%", bottom: "-20%", width: "300px", height: "300px", borderRadius: "50%", background: "radial-gradient(circle, rgba(10, 82, 185, 0.08) 0%, transparent 70%)" }} />
      </section>
      ...
      <section style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "24px" }}>
        {filteredProjects.length > 0 ? (
          filteredProjects.map((project) => {
            let badgeStyle = { backgroundColor: "rgba(10, 82, 185, 0.15)", color: "var(--color-secondary)", border: "1px solid rgba(10, 82, 185, 0.3)" };
            ...
            return (
              <article
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.borderColor = "rgba(10, 82, 185, 0.35)";
                }}
                onMouseLeave={(e) => {
            ...
            <div style={{ width: "100%", height: "200px", position: "relative", overflow: "hidden", flexShrink: 0 }}>
              ...
              <div
                style={{
                  ...
                  bottom: "20px",
                  left: "24px",
                  backgroundColor: "rgba(10, 82, 185, 0.2)",
                  border: "1px solid var(--color-secondary)",
