    ...
    <div className="animate-fadeIn">
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 10, maxWidth: "600px" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", backgroundColor: "rgba(37, 99, 235, 0.15)", border: "1px solid rgba(37, 99, 235, 0.3)", padding: "4px 10px", borderRadius: "2px", marginBottom: "16px" }}>
