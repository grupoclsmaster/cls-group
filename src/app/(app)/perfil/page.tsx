  ...
  return (
    <div className="animate-fadeIn">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .conn-card:hover {
          border-color: rgba(145, 179, 225, 0.25);
        }
        .req-card {
          background-color: var(--color-surface-container-low);
        ...
        .social-btn-hover:hover {
          ...
          border-color: rgba(145, 179, 225, 0.3) !important;
          background-color: rgba(145, 179, 225, 0.08) !important;
        ...
        <div className="profile-container">
          ...
          <div>
            {!isEditing ? (
              ...
              /* Edit Profile Form */
              <form onSubmit={handleUpdateProfile} className="profile-card" style={{ border: "1px solid rgba(145, 179, 225, 0.2)" }}>
                ...
                >
                  {editImg ? (
                    ...
                    <div style={{
                      ...
                      height: "96px",
                      borderRadius: "50%",
                      backgroundColor: "rgba(145, 179, 225, 0.05)",
                            ...
                            return (
                              <div key={conn.id} className="conn-card">
                                ...
                                <button
                                  ...
                                  onMouseLeave={(e) => {
                                    if (!isPending && !isAcceptedStatus) {
                                      e.currentTarget.style.backgroundColor = "rgba(145, 179, 225, 0.08)";
