                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "8px", flexWrap: "wrap", gap: "8px" }}>
                      <span
                        style={{
                          ...
                          padding: "2px 6px",
                          borderRadius: "2px",
                          backgroundColor: log.type === "customer.member_added" ? "rgba(10, 82, 185, 0.15)" : "rgba(255,100,100,0.15)",
                          color: log.type === "customer.member_added" ? "var(--color-secondary)" : "#ffb4ab",
                          border: log.type === "customer.member_added" ? "1px solid rgba(10, 82, 185, 0.3)" : "1px solid rgba(255, 100, 100, 0.3)",
                        }}
                      >
                        {log.type}
                      </span>
        ...
        <div className="glass-panel" style={{ padding: "20px", borderRadius: "4px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: "20px" }}>
            {members.map((member, i) => (
              ...
              >
                <div style={{ width: "40px", height: "40px", borderRadius: "50%", overflow: "hidden", border: "1px solid rgba(10, 82, 185,0.2)" }}>
                ...
                <span
                  style={{
                    ...
                    padding: "2px 6px",
                    borderRadius: "2px",
                    backgroundColor: member.status === "Inativo" ? "rgba(255, 100, 100, 0.15)" : "rgba(10, 82, 185, 0.15)",
                    color: member.status === "Inativo" ? "#ffb4ab" : "var(--color-secondary)",
                    border: member.status === "Inativo" ? "1px solid rgba(255, 100, 100, 0.3)" : "1px solid rgba(10, 82, 185, 0.3)"
                  }}
                >
                  {member.status || "Ativo"}
                </span>
        ...
        >
          <div
            ...
            style={{
              ...
              border: "1px solid rgba(10, 82, 185, 0.2)",
              position: "relative",
            }}
          >
            {/* Close */}
