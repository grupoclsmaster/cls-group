        ...
        {isAdmin && (
          <Link
            ...
            style={{
              ...
              padding: "6px 14px",
              borderRadius: "20px",
              background: "linear-gradient(135deg, rgba(37, 99, 235, 0.15) 0%, rgba(107, 70, 193, 0.15) 100%)",
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.background = "linear-gradient(135deg, rgba(37, 99, 235, 0.25) 0%, rgba(107, 70, 193, 0.25) 100%)";
              e.currentTarget.style.borderColor = "var(--color-secondary-fixed)";
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.background = "linear-gradient(135deg, rgba(37, 99, 235, 0.15) 0%, rgba(107, 70, 193, 0.15) 100%)";
                ...
                >
                  {notifications.length === 0 ? (
                    ...
                    notifications.map((item) => {
                      ...
                      let iconBg = "rgba(37, 99, 235, 0.15)";
